...
export const ALL_NAV_ITEMS = [
  ...
  // 4. DASHBOARD
  {
    ...
    children: [
      {
        id: "dashboard-light",
        label: "nav.dashboardLight",
        path: "/dashboard/index",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER, ROLES.INSTRUCTOR],
      },
      {
        id: "dashboard-dark",
        label: "nav.dashboardDark",
  ...
  // 7. APPS
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            id: "shop-product-create",
            label: "nav.createproduct",
            path: "/dashboard/ecom-product-create",
            roles: [
              ROLES.ADMIN,
              ROLES.MANAGER,
              ROLES.CUSTOMER,
        ...
        
          {
          ...
          },
           {
            id: "shop-wishlist",
            label: "Wishlist",
            path: "/dashboard/ecom-product-wishlist",
            roles: [
          ...
          },
           {
            id: "shop-cart",
            label: "Cart",
            path: "/dashboard/ecom-product-cart",
            roles: [
    ...
    children: [
      {
        id: "chart-flot",
        label: "nav.flot",
        path: "/dashboard/chart-flot",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "chart-morris",
        label: "nav.morris",
        path: "/dashboard/chart-morris",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "chart-chartjs",
        label: "nav.chartjs",
        path: "/dashboard/chart-chartjs",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "chart-chartist",
        label: "nav.chartist",
        path: "/dashboard/chart-chartist",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "chart-sparkline",
        label: "nav.sparkline",
        path: "/dashboard/chart-sparkline",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "chart-peity",
        label: "nav.peity",
        path: "/dashboard/chart-peity",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
    ],
  },
    ...
    children: [
      {
        id: "ui-accordion",
        label: "nav.accordion",
        path: "/dashboard/ui-accordion",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-alert",
        label: "nav.alert",
        path: "/dashboard/ui-alert",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-badge",
        label: "nav.badge",
        path: "/dashboard/ui-badge",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-button",
        label: "nav.button",
        path: "/dashboard/ui-button",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-modal",
        label: "nav.modal",
        path: "/dashboard/ui-modal",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-button-group",
        label: "nav.buttonGroup",
        path: "/dashboard/ui-button-group",
        roles: [ROLES.ADMIN],
      },
      {
        id: "ui-list-group",
      ...
      },
      {
        id: "ui-dropdown",
        label: "nav.dropdown",
        path: "/dashboard/ui-dropdown",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-popover",
        label: "nav.popover",
        path: "/dashboard/ui-popover",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-progressbar",
        label: "nav.progressbar",
        path: "/dashboard/ui-progressbar",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-tab",
        label: "nav.tab",
        path: "/dashboard/ui-tab",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "ui-typography",
      ...
      {
        id: "ui-pagination",
        label: "nav.pagination",
        path: "/dashboard/ui-pagination",
        roles: [ROLES.ADMIN],
      },
      {
        id: "ui-grid",
    ...
    children: [
      {
        id: "uc-select2",
        label: "nav.select2",
        path: "/dashboard/uc-select2",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "uc-nestable",
        label: "nav.nestedTable",
        path: "/dashboard/uc-nestable",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "uc-noui-slider",
        label: "nav.nouiSlider",
        path: "/dashboard/uc-noui-slider",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "uc-sweetalert",
        label: "nav.sweetAlert",
        path: "/dashboard/uc-sweetalert",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "uc-toastr",
        label: "nav.toastr",
        path: "/dashboard/uc-toastr",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "map-jqvmap",
        label: "nav.jqvMap",
        path: "/dashboard/map-jqvmap",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "uc-lightgallery",
        label: "nav.lightGallery",
        path: "/dashboard/uc-lightgallery",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
    ],
  },
  ...
  // 12. FORMS
  {
    ...
    children: [
      {
        id: "form-element",
        label: "nav.formElements",
        path: "/dashboard/form-element",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "form-wizard",
      ...
      },
      {
        id: "form-ckeditor",
        label: "nav.ckEditor",
        path: "/dashboard/form-ckeditor",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "form-pickers",
        label: "nav.pickers",
        path: "/dashboard/form-pickers",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "form-validation",
        label: "nav.formValidate",
    ...
    children: [
      {
        id: "table-bootstrap",
        label: "nav.bootstrap",
        path: "/dashboard/table-bootstrap-basic",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "table-datatable",
        label: "nav.datatable",
        path: "/dashboard/table-datatable-basic",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
    ],
  },
  ...
  // 14. PAGES
  {
    ...
    children: [
        ...
        children: [
          {
            id: "error-400",
            label: "nav.error400",
            path: "/dashboard/page-error-400",
            roles: [ROLES.ADMIN],
          },
          {
            id: "error-403",
            label: "nav.error403",
            path: "/dashboard/page-error-403",
            roles: [ROLES.ADMIN],
          },
          {
            id: "error-404",
            label: "nav.error404",
            path: "/dashboard/page-error-404",
            roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
          },
          {
            id: "error-500",
            label: "nav.error500",
            path: "/dashboard/page-error-500",
            roles: [ROLES.ADMIN],
          },
          {
            id: "error-503",
            label: "nav.error503",
            path: "/dashboard/page-error-503",
            roles: [ROLES.ADMIN],
          },
        ],
      },
      {
        id: "page-lock-screen",
        label: "nav.lockScreen",
        path: "/dashboard/page-lock-screen",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
      {
        id: "page-empty",
        label: "nav.emptyPage",
        path: "/dashboard/empty-page",
        roles: [ROLES.ADMIN, ROLES.MANAGER, ROLES.CUSTOMER],
      },
    ],
  },
