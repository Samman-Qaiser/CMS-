...
export const ALL_NAV_ITEMS = [
  ...
  // 6. INSTRUCTOR
  {
    ...
    roles: [ROLES.ADMIN, ROLES.MANAGER],
    children: [
      { id: 'instructor-dashboard',    label: 'nav.instructorDashboard',    path: '/dashboard/instructor-dashboard',    roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-courses',      label: 'nav.instructorCourses',      path: '/dashboard/instructor-courses',      roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-schedule',     label: 'nav.instructorSchedule',     path: '/dashboard/instructor-schedule',     roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-students',     label: 'nav.instructorStudents',     path: '/dashboard/instructor-students',     roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-resources',    label: 'nav.instructorResources',    path: '/dashboard/instructor-resources',    roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-transactions', label: 'nav.instructorTransactions', path: '/dashboard/instructor-transactions', roles: [ROLES.ADMIN, ROLES.MANAGER] },
      { id: 'instructor-liveclass',    label: 'nav.instructorLiveclass',    path: '/dashboard/instructor-liveclass',    roles: [ROLES.ADMIN, ROLES.MANAGER] },
    ],
  },
