  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDF2F2] p-4 font-poppins">
      <div className="bg-white rounded-xl shadow-lg p-8 md:p-10 w-full max-w-2xl">
        ...
        <h2 className="text-center text-lg font-bold text-[#2C3E50] mb-8">Sign up your account</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="text-xs font-bold text-gray-600 uppercase mb-2 block">First Name</label>
              <input 
                {...register("firstName", { required: "First name is required" })}
                type="text" 
                placeholder="First Name"
                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-400 outline-none transition"
              />
              {errors.firstName && <p className="text-red-500 text-[10px] mt-1">{errors.firstName.message}</p>}
            </div>
            <div>
              <label className="text-xs font-bold text-gray-600 uppercase mb-2 block">Last Name</label>
              <input 
          ...
          {/* Email Field */}
          <div>
            <label className="text-xs font-bold text-gray-600 uppercase mb-2 block">Email</label>
            <input 
              {...register("email", { 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-xs font-bold text-gray-600 uppercase mb-2 block">Confirm Password</label>
              <input 
          ...
          <button 
            type="submit" 
            className="w-full py-3 mt-4 bg-[#FF6D52] text-white font-bold rounded-lg hover:bg-[#ff5a3d] shadow-lg transition-all active:scale-[0.98]"
          >
            Sign me up
          </button>
        </form>
