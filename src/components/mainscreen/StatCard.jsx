...
const StatCard = ({ icon: Icon, count, label, bgColor, delay = 0 }) => {
  return (
    <motion.div
      ...
      className="relative group overflow-hidden rounded-2xl p-6 flex items-center gap-4 h-[110px] shadow-sm"
    ...
    >
      ...
      <div className="absolute group-hover:scale-125 transition-all ease-linear -right-2 top-1/2 -translate-y-1/2 opacity-20 pointer-events-none">
