...
const CompactSidebar = () => {
  ...
  return (
    <div
      className="fixed left-0 top-0 h-screen w-50 flex flex-col border-r border-gray-200/10 z-50 shadow-lg overflow-y-auto transition-all duration-300"
      style={{ backgroundColor: "var(--sidebar-bg)" }}
    >
      {/* Header */}
      <div
        className="w-full flex items-center px-6 py-4 sticky top-0 z-10 transition-colors duration-300"
          ...
          return (
            <div key={item.id} className="flex flex-col">
              ...
              >
                <div className="relative flex flex-col items-center justify-center gap-3">
                  ...
                  >
                    <item.icon
                      size={20}
                      style={{ opacity: !isLightSidebar && !isOpen ? 0.8 : 1 }}
                    />
                  </div>
              ...
              {item.children && isOpen && (
                <div
                  className="flex flex-col items-center mt-1 border-l border-gray-200/10"
                  style={{
                    ...
                    return (
                      ...
                      >
                        ...
                        {hasSubChildren && isSubOpen && (
                          <div
                            className="flex flex-col ml-4 my-1 rounded-lg transition-colors duration-300"
                            style={{
