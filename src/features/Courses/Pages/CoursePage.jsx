  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Popular — totalStudents se sort
        const popular = [...coursesData.courses]
      ...
      {totalPages > 1 && (
        <div className="flex flex-col md:flex-row justify-between items-center mt-12 gap-4">
          <p className="text-content-text text-sm">
            ...
            from{' '}
            <span className="font-bold text-header-text">{allCourses.length}</span> data
          </p>
