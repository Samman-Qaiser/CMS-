...
export default function LatestTransactionTable() {
  ...
  // Handler to update status via PUT request
  ...
  if (loading)
    return <div className="p-5 text-center">Loading transactions...</div>;
          ...
          <tbody>
            {transactions.map((t) => (
              ...
              >
                ...
                <td className="py-3.5 px-2 font-semibold">${t.amount}</td>
                ...
                <td className="py-3.5 px-2">
                  <button className="flex items-center gap-2 text-xs text-content-text hover:text-header-text">
                    Download <BsDownload />
                  </button>
                </td>
              </tr>
